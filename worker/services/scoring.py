...
def _compute_grade_2_score(counts: Dict[str, int], total_words: int) -> Dict[str, Any]:
    """
...
def _compute_grade_1_score(counts: Dict[str, int], total_words: int) -> Dict[str, Any]:
    """
