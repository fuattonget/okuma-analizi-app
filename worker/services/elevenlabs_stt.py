...
class ElevenLabsSTT:
    ...
    def __init__(self, api_key: str, model: str = "scribe_v1", language: str = "tr", temperature: float = 0.0):
    ...
    def transcribe_file(self, file_path: str) -> Dict[str, Any]:
        ...
        """
        try:
            logger.info(f"Starting ElevenLabs transcription for file: {file_path}")
...
def transcribe_audio_elevenlabs(file_path: str, api_key: str, model: str = "scribe_v1", language: str = "tr") -> Dict[str, Any]:
    """
    ...
    Returns:
        Dictionary with transcription results
    """
    stt_client = ElevenLabsSTT(api_key, model, language)
